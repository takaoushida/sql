...
with
stock_data as(
    select * from feature_learning_dev.stock_data_explanatory_valiable_add_20251203
...
left join
    feature_learning_dev.feature_learning_win as t4
    on t1.stock_code = t4.stock_code and t1.created_at = t4.created_at
left join
    feature_learning_dev.feature_learning_lose as t5
