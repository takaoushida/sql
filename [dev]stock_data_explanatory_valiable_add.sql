...
##################################################################################################################################################################################################################
##################################################################################################################################################################################################################
create or replace table feature_learning_dev.stock_data_explanatory_valiable_add_20260423
partition by created_at 
cluster by stock_code as(
with
...
point_add as(
    select
        ...
        stock_reward,--調整後配当
        --前quarter比の経営指標
        quarter_earnings_rate,
        quarter_operating_income_rate,
        quarter_ordinaly_profit_rate,
        quarter_net_income_rate,
        --前年同期比の経営指標
        earnings_rate,
        operating_income_rate,
        ordinaly_profit_rate,
        net_income_rate,
